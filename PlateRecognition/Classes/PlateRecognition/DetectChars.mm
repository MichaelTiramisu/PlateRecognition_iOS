...
bool loadKNNDataAndTrainKNN() {
    ...
    NSString *fileString = [[NSBundle mainBundle] pathForResource:@"classifications.xml" ofType:nil];
    
//    cv::FileStorage fsClassifications("/Users/lsy/Desktop/TestOpenCV_iOS/TestOpenCV_iOS/PlateRecognition/classifications.xml", cv::FileStorage::READ);        // open the classifications file
    cv::FileStorage fsClassifications([fileString UTF8String], cv::FileStorage::READ);        // open the classifications file
    ...
    NSString *trainFileString = [[NSBundle mainBundle] pathForResource:@"images.xml" ofType:nil];
//    cv::FileStorage fsTrainingImages("/Users/lsy/Desktop/TestOpenCV_iOS/TestOpenCV_iOS/PlateRecognition/images.xml", cv::FileStorage::READ);              // open the training images file
    cv::FileStorage fsTrainingImages([trainFileString UTF8String], cv::FileStorage::READ);              // open the training images file
